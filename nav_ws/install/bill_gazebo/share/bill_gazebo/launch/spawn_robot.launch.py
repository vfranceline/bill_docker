...
def generate_launch_description():
    ...
    pkg_gazebo_path = get_package_share_directory('bill_gazebo')
    ...
    # launchDescriptionObject.add_action(joint_state_publisher_gui_node) # o gz_bridge vai cuidar dessa parte
